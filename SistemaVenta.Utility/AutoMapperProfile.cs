    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<Usuario, UsuarioDTO>()
                .ForMember(destino =>
                destino.RoleDescripcion,
                opt => opt.MapFrom(origen => origen.Role.Nombre)
                )
                .ForMember(destino =>
                destino.EsActivo,
            ...
            CreateMap<Producto, ProductoDTO>()
                ...
                opt => opt.MapFrom(origen => origen.Categoria.Nombre))
                .ForMember(destino =>
                destino.Precio,
            ...
            CreateMap<DetalleVenta, ReporteDTO>()
                .ForMember(destino =>
                destino.FechaRegistro,
                opt => opt.MapFrom(origen => origen.Venta.FechaRegistro.Value.ToString("dd/MM/yyyy")))
                .ForMember(destino =>
                destino.NumeroDocumento,
                opt => opt.MapFrom(origen => origen.Venta.NumeroDocumento))
                .ForMember(destino =>
                destino.TipoPago,
                opt => opt.MapFrom(origen => origen.Venta.TipoPago))
                .ForMember(destino =>
                destino.TotalVenta,
                opt => opt.MapFrom(origen => Convert.ToString(origen.Venta.Total.Value, new CultureInfo("es-MX"))))
                .ForMember(destino =>
                destino.Producto,
                opt => opt.MapFrom(origen => origen.Producto.Nombre))
                .ForMember(destino =>
